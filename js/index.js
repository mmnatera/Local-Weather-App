...
(function () {
    ...
    var displayRegion = document.getElementById("region"); // get DOM references.
    ...
    var backgroundPicture = "https://s3.ca-central-1.amazonaws.com/marianateralocalweatherapp/clear.jpg"; // set default background picture.
    var cityName = "";
    var regionName = "";
    var countryName = "";
    var locationString = "";
    ...
    function getWeatherData() {
        var url = 'https://api.openweathermap.org/data/2.5/weather?lat=' + latitude + '&lon=' +  // build query url.
            longitude + '&APPID=a71c9e5ba0c0283a5a75081ac1a788ec' +
    ...
    function weatherPicture() {
        switch (true) {
            case /\bclear\b/i.test(currentWeather):                     // match uses regular expression.
                backgroundPicture = 'https://s3.ca-central-1.amazonaws.com/marianateralocalweatherapp/clear.jpg';
                break;
            case /\bovercast\b/i.test(currentWeather):
                backgroundPicture = 'https://s3.ca-central-1.amazonaws.com/marianateralocalweatherapp/overcast2.jpg';
                break;
            case /\bclouds\b/i.test(currentWeather):
                backgroundPicture = 'https://s3.ca-central-1.amazonaws.com/marianateralocalweatherapp/mostlycloudy.jpg';
                break;
            case /\brain\b/i.test(currentWeather):
                backgroundPicture = 'https://s3.ca-central-1.amazonaws.com/marianateralocalweatherapp/rainy.jpg';
                break;
            case /\bdrizzle\b/i.test(currentWeather):
                backgroundPicture = 'https://s3.ca-central-1.amazonaws.com/marianateralocalweatherapp/drizzle.jpg';
                break;
            case /\bthunderstorm\b/i.test(currentWeather):
                backgroundPicture = 'https://s3.ca-central-1.amazonaws.com/marianateralocalweatherapp/thunderstorm.jpg';
                break;
            case /\bsnow\b/i.test(currentWeather):
                backgroundPicture = 'https://s3.ca-central-1.amazonaws.com/marianateralocalweatherapp/snow.jpg';
                break;
            case /\bmist\b/i.test(currentWeather):
                backgroundPicture = 'https://s3.ca-central-1.amazonaws.com/marianateralocalweatherapp/mist.jpg';
                break;
            case /\bfog\b/i.test(currentWeather):
                backgroundPicture = 'https://s3.ca-central-1.amazonaws.com/marianateralocalweatherapp/fog.jpg';
                break;
        }
    }
